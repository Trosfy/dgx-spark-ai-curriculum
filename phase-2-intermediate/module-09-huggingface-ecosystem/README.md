...
|---|------|------|-------------|
| 9.1 | Hub Exploration | 2h | Document 10 models, test 3 locally |
| 9.2 | Pipeline Showcase | 2h | Demo 5 pipelines (text-gen, sentiment, NER, QA, summarization) |
| 9.3 | Dataset Processing | 2h | Process large dataset with map(), create splits |
| 9.4 | Trainer Fine-tuning | 2h | Text classification with custom metrics |
| 9.5 | LoRA Introduction | 2h | Compare LoRA vs full fine-tuning memory |
| 9.6 | Model Upload | 2h | Fine-tune, create model card, upload to Hub |
