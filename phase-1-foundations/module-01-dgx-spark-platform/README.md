...
### 1.1 Hardware Architecture Deep-Dive
...
### Task 1.1: System Exploration
**Time:** 1 hour

Explore your DGX Spark hardware and document its configuration.

**Instructions:**
1. Open the notebook `01-system-exploration.ipynb`
...
**Instructions:**
1. Open `02-memory-architecture-lab.ipynb`
...
### Task 1.3: NGC Container Setup
**Time:** 1.5 hours

Configure NGC containers for development.

**Instructions:**
1. Open `03-ngc-container-setup.ipynb`
...
**Instructions:**
1. Open `04-compatibility-matrix.ipynb`
...
3. ➡️ Proceed to [Module 2: Python for AI/ML](../module-02-python-for-ai/)
