...
if not os.path.isdir(_scripts_dir):
    ...
    print("To fix this:")
    print("  1. cd phase-3-advanced/module-12-deployment-inference")
...
try:
    ...
    print("\nTo fix this:")
    print("  1. Ensure you're running from the module-12-deployment-inference directory")
    print("  2. Or run: cd phase-3-advanced/module-12-deployment-inference && python api/api_server.py")
