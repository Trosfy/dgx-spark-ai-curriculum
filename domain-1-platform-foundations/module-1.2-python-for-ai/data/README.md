...
```bash
cd domain-1-platform-foundations/module-1.2-python-for-ai/data
...
- `preprocessor.pkl` - Saved preprocessor object from Lab 1.2.2
- `model_dashboard.png` - Saved visualization from Lab 1.2.3
