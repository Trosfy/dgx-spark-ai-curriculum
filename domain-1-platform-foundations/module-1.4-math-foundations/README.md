...
**Prerequisites:** Module 1.3 (CUDA Python), High school calculus
...
| [PREREQUISITES.md](./PREREQUISITES.md) | Required skills and self-assessment |
...
3. ➡️ Proceed to [Module 1.5: Neural Network Fundamentals](../module-1.5-neural-networks/)
