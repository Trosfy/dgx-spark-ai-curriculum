...
**Prerequisites:** Modules 1.1-1.6

---

## Overview

This capstone project consolidates everything you've learned in Domain 1. You'll build **MicroGrad+**, an extended version of Andrej Karpathy's micrograd—a tiny autograd engine that can train neural networks. This project demonstrates your understanding of automatic differentiation, neural network components, and software engineering practices.
...
|----|-----------|---------------|
| 1.7.1 | Design a modular architecture for neural network components | Create |
| 1.7.2 | Implement automatic differentiation for common operations | Apply |
| 1.7.3 | Write comprehensive unit tests for neural network operations | Apply |
| 1.7.4 | Document code with docstrings and usage examples | Create |
...
| [PREREQUISITES.md](./PREREQUISITES.md) | Skills checklist before starting |
...
Next: [Domain 2: Intermediate](../../domain-2-deep-learning-frameworks/) where you'll use PyTorch for more advanced architectures.
