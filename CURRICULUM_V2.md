# NVIDIA DGX Spark AI Mastery Curriculum v2.0
...
Based on comprehensive curriculum research, v2.0 adds significant new content organized by priority:
...
├── Module 1.3: CUDA Python & GPU Programming ⭐ NEW [P0]
├── Module 1.4: Mathematics for Deep Learning
├── Module 1.5: Neural Network Fundamentals
├── Module 1.6: Classical ML Foundations ⭐ NEW [P2]
└── Module 1.7: Capstone — MicroGrad+

DOMAIN 2: DEEP LEARNING FRAMEWORKS (Weeks 8-15)
├── Module 2.1: Deep Learning with PyTorch
├── Module 2.2: Computer Vision (expanded: ViT, YOLO) [P2]
├── Module 2.3: NLP & Transformers (expanded: Tokenizer Training) [P2]
...
├── Module 3.1: LLM Fine-Tuning ⭐ EXPANDED [P1] (DoRA, NEFTune, SimPO, ORPO, KTO)
├── Module 3.2: Quantization & Optimization ⭐ EXPANDED [P0] (NVFP4, FP8)
├── Module 3.3: Deployment & Inference ⭐ EXPANDED [P1] (SGLang, Speculative Decoding)
├── Module 3.4: Test-Time Compute & Reasoning ⭐ NEW [P1]
├── Module 3.5: RAG Systems & Vector Databases ⭐ NEW [P0]
└── Module 3.6: AI Agents & Agentic Systems

DOMAIN 4: PRODUCTION AI (Weeks 27-40)
├── Module 4.1: Multimodal AI
├── Module 4.2: AI Safety & Alignment ⭐ NEW [P0]
├── Module 4.3: MLOps & Experiment Tracking ⭐ EXPANDED [P0/P1]
├── Module 4.4: Containerization & Deployment ⭐ NEW [P0/P1] (Docker, K8s, Cloud)
├── Module 4.5: Demo Building & Prototyping ⭐ NEW [P2]
...
5. **Learning Theory Foundations [P3 Optional]**
...
## Module 2.2: Computer Vision (Expanded) [P2]
...
3. **Object Detection [P2 Expansion]**
...
5. **Vision Transformers [P2 Expansion]**
...
## Module 2.3: NLP & Transformers (Expanded) [P2]
...
| 2.3.2 | Train custom tokenizers from scratch [P2] | Apply |
...
## Module 2.4: Efficient Architectures ⭐ NEW [P1]
...
## Module 3.1: LLM Fine-Tuning ⭐ EXPANDED [P1]
...
2. **Advanced LoRA Variants [P1 Expansion]**
...
3. **Training Enhancements [P1 Expansion]**
...
5. **Preference Optimization [P1 Expansion]**
   ...
   - **KTO**: Kahneman-Tversky Optimization (binary signals) [P2]
...
## Module 3.2: Quantization & Optimization ⭐ EXPANDED [P0]
...
2. **Blackwell-Specific Quantization [P0 Expansion]**
...
## Module 3.3: Deployment & Inference ⭐ EXPANDED [P1]
...
1. **Inference Engine Overview**
   ...
   - **SGLang** (RadixAttention, 29-45% faster than vLLM) [P1]

2. **Speculative Decoding [P1 Expansion]**
...
2. **Cloud Deployment [P1]**
   - AWS SageMaker endpoints
   - GCP Vertex AI deployment
   - Azure ML (overview)
   - Cost optimization strategies

3. **Kubernetes Basics [P2]**
...
| 2.0 | 2025-12 | Major expansion based on curriculum research: Added CUDA Python [P0], NVFP4/FP8 quantization [P0], RAG systems [P0], AI Safety [P0], Docker/Cloud deployment [P0], Mamba/MoE architectures [P1], Diffusion models [P1], Modern fine-tuning methods (DoRA, NEFTune, SimPO, ORPO) [P1], SGLang/speculative decoding [P1], Test-time compute [P1], Classical ML [P2], Object detection/ViT [P2], Kubernetes [P2], Gradio/Streamlit [P2], Optional modules for Learning Theory, Recommender Systems, Mechanistic Interpretability, RL, GNNs [P3] |
