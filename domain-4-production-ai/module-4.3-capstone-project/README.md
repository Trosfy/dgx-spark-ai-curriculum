...
Build a complete AI assistant for a specific domain.
...
Build a system for understanding complex documents.
...
- Benchmark on document datasets
...
|-------|----------|------------|
| **Planning** | Week 27 | Requirements, architecture, tech selection |
| **Foundation** | Weeks 28-29 | Core components, data prep, initial models |
...
| **Documentation** | Week 32 | Docs, demo, presentation |
...
| Criteria | Points |
|----------|--------|
| Technical complexity and correctness | 25 |
| Effective use of DGX Spark capabilities | 20 |
| Code quality and organization | 15 |
| Documentation and presentation | 15 |
| Evaluation and benchmarking | 15 |
