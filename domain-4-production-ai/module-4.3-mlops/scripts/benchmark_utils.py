"""
Benchmark Utilities for LLM Evaluation.

This module provides utilities for running LLM benchmarks using
the LM Evaluation Harness and analyzing results.
...
def run_benchmark(
    ...
    Returns:
        BenchmarkResult object with results, or None if failed
...
def format_benchmark_results(
    ...
    Example:
        >>> formatted = format_benchmark_results(comparison)
        >>> print(formatted)
    """
    lines = []
    lines.append("=" * 70)
...
if __name__ == "__main__":
    ...
    print("\nExample usage:")
    print("  from benchmark_utils import run_benchmark, get_benchmark_suite")
