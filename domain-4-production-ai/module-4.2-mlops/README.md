...
| 4.2.2 | Design custom evaluation suites | Create |
| 4.2.3 | Track experiments with MLflow | Apply |
...
### 4.2.1 LLM Benchmarks
- MMLU, HellaSwag, ARC, WinoGrande
- HumanEval (code)
- MT-Bench (chat)
- LM Evaluation Harness

### 4.2.2 Custom Evaluation
...
|---|------|------|-------------|
| 4.2.1 | Benchmark Suite | 3h | lm-eval on multiple models |
| 4.2.2 | Custom Eval Framework | 2h | Task-specific + LLM-as-judge |
| 4.2.3 | MLflow Setup | 2h | Tracking server with dashboards |
| 4.2.4 | Model Registry | 2h | Version control workflow |
| 4.2.5 | Reproducibility Audit | 2h | Verify training reproducibility |
